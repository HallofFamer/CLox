...
void registerCollectionPackage(VM* vm) {
    ...
    DEF_METHOD(collectionClass, Collection, addAll, 1, RETURN_TYPE(Nil), PARAM_TYPE(clox.std.collection.Collection));
    DEF_METHOD(collectionClass, Collection, collect, 1, RETURN_TYPE(clox.std.collection.Collection), PARAM_TYPE(TCallable));
    DEF_METHOD(collectionClass, Collection, detect, 1, RETURN_TYPE(Object), PARAM_TYPE(TCallable));
    DEF_METHOD(collectionClass, Collection, each, 1, RETURN_TYPE(Nil), PARAM_TYPE(TCallable));
    DEF_METHOD(collectionClass, Collection, isEmpty, 0, RETURN_TYPE(Bool));
    ...
    DEF_METHOD(vm->arrayClass, Array, clear, 0, RETURN_TYPE(Nil));
    DEF_METHOD(vm->arrayClass, Array, clone, 0, RETURN_TYPE(clox.std.collection.Array));
    DEF_METHOD(vm->arrayClass, Array, collect, 1, RETURN_TYPE(clox.std.collection.Array), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->arrayClass, Array, contains, 1, RETURN_TYPE(Bool), PARAM_TYPE(Object));
    DEF_METHOD(vm->arrayClass, Array, detect, 1, RETURN_TYPE(Object), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->arrayClass, Array, each, 1, RETURN_TYPE(Nil), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->arrayClass, Array, eachIndex, 1, RETURN_TYPE(Nil), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->arrayClass, Array, equals, 1, RETURN_TYPE(Bool), PARAM_TYPE(Object));
    DEF_METHOD(vm->arrayClass, Array, fill, 2, RETURN_TYPE(Nil), PARAM_TYPE(Int), PARAM_TYPE(Object));
    DEF_METHOD(vm->arrayClass, Array, getAt, 1, RETURN_TYPE(Object), PARAM_TYPE(Int));
    DEF_METHOD(vm->arrayClass, Array, indexOf, 1, RETURN_TYPE(Int), PARAM_TYPE(Object));
    DEF_METHOD(vm->arrayClass, Array, insertAt, 2, RETURN_TYPE(Nil), PARAM_TYPE(Int), PARAM_TYPE(Object));
    ...
    DEF_METHOD(vm->arrayClass, Array, putAt, 2, RETURN_TYPE(Nil), PARAM_TYPE(Int), PARAM_TYPE(Object));
    DEF_METHOD(vm->arrayClass, Array, reject, 1, RETURN_TYPE(clox.std.collection.Array), PARAM_TYPE(TCallable));
    ...
    DEF_METHOD(linkedListClass, LinkedList, addFirst, 1, RETURN_TYPE(Nil), PARAM_TYPE(Object));
    DEF_METHOD(linkedListClass, LinkedList, addLast, 1, RETURN_TYPE(Nil), PARAM_TYPE(Object));
    DEF_METHOD(linkedListClass, LinkedList, clear, 0, RETURN_TYPE(Nil));
    DEF_METHOD(linkedListClass, LinkedList, contains, 1, RETURN_TYPE(Bool), PARAM_TYPE(Object));
    DEF_METHOD(linkedListClass, LinkedList, getAt, 1, RETURN_TYPE(Object), PARAM_TYPE(Int));
    DEF_METHOD(linkedListClass, LinkedList, getFirst, 0, RETURN_TYPE(Object));
    ...
    DEF_METHOD(linkedListClass, LinkedList, putAt, 2, RETURN_TYPE(Nil), PARAM_TYPE(Int), PARAM_TYPE(Object));
    DEF_METHOD(linkedListClass, LinkedList, remove, 0, RETURN_TYPE(Object));
    DEF_METHOD(linkedListClass, LinkedList, removeFirst, 0, RETURN_TYPE(Object));
    ...
    DEF_METHOD(vm->nodeClass, Node, next, 0, RETURN_TYPE(clox.std.collection.Node));
    ...
    DEF_METHOD(vm->dictionaryClass, Dictionary, clear, 0, RETURN_TYPE(Nil));
    DEF_METHOD(vm->dictionaryClass, Dictionary, clone, 0, RETURN_TYPE(clox.std.collection.Dictionary));
    DEF_METHOD(vm->dictionaryClass, Dictionary, collect, 1, RETURN_TYPE(clox.std.collection.Dictionary), PARAM_TYPE(TCallable));
    ...
    DEF_METHOD(vm->dictionaryClass, Dictionary, detect, 1, RETURN_TYPE(Object), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->dictionaryClass, Dictionary, each, 1, RETURN_TYPE(Nil), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->dictionaryClass, Dictionary, eachKey, 1, RETURN_TYPE(Nil), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->dictionaryClass, Dictionary, eachValue, 1, RETURN_TYPE(Nil), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->dictionaryClass, Dictionary, entrySet, 0, RETURN_TYPE(Object));
    ...
    DEF_METHOD(vm->dictionaryClass, Dictionary, keySet, 0, RETURN_TYPE(Object));
    ...
    DEF_METHOD(vm->dictionaryClass, Dictionary, putAll, 1, RETURN_TYPE(Object), PARAM_TYPE(clox.std.collection.Dictionary));
    DEF_METHOD(vm->dictionaryClass, Dictionary, putAt, 2, RETURN_TYPE(Object), PARAM_TYPE(Object), PARAM_TYPE(Object));
    DEF_METHOD(vm->dictionaryClass, Dictionary, reject, 1, RETURN_TYPE(clox.std.collection.Dictionary), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->dictionaryClass, Dictionary, removeAt, 1, RETURN_TYPE(Object), PARAM_TYPE(Int));
    DEF_METHOD(vm->dictionaryClass, Dictionary, select, 1, RETURN_TYPE(clox.std.collection.Dictionary), PARAM_TYPE(TCallable));
    DEF_METHOD(vm->dictionaryClass, Dictionary, toString, 0, RETURN_TYPE(String));
    DEF_METHOD(vm->dictionaryClass, Dictionary, valueSet, 0, RETURN_TYPE(Object));
    ...
    DEF_METHOD(setClass, Set, clear, 0, RETURN_TYPE(Nil));
    DEF_METHOD(setClass, Set, clone, 0, RETURN_TYPE(Set));
    ...
    DEF_METHOD(vm->rangeClass, Range, addAll, 1, RETURN_TYPE(Nil), PARAM_TYPE(clox.std.collection.Collection));
    ...
    DEF_METHOD(vm->rangeClass, Range, step, 2, RETURN_TYPE(Nil), PARAM_TYPE(Int), PARAM_TYPE(TCallable));
    ...
    DEF_METHOD(stackClass, Stack, push, 1, RETURN_TYPE(Nil), PARAM_TYPE(Object));
    ...
    DEF_METHOD(queueClass, Queue, dequeue, 0, RETURN_TYPE(Object));
    DEF_METHOD(queueClass, Queue, enqueue, 1, RETURN_TYPE(Nil), PARAM_TYPE(Object));
