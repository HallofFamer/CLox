...
typedef enum {
    ...
    TOKEN_CASE, TOKEN_CATCH, TOKEN_CLASS, TOKEN_CONTINUE, 
    TOKEN_DEFAULT, TOKEN_ELSE, TOKEN_FALSE, TOKEN_FINALLY, TOKEN_FOR, 
    TOKEN_FROM, TOKEN_FUN, TOKEN_IF, TOKEN_NAMESPACE, TOKEN_NIL, 
    TOKEN_OR, TOKEN_REQUIRE, TOKEN_RETURN, TOKEN_SUPER, TOKEN_SWITCH, 
    TOKEN_THIS, TOKEN_THROW, TOKEN_TRAIT, TOKEN_TRUE, TOKEN_TRY,
    TOKEN_USING, TOKEN_VAL, TOKEN_VAR, TOKEN_WHILE, TOKEN_WITH, TOKEN_YIELD,
